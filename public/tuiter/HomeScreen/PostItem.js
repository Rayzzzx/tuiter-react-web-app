                    ...
                    <div class="card mt-2 border-secondary rounded-4">
                      ...
                      ${post.topicTitle || post.topicContent || post.topicLink ?
                        `<div class="card-body border-top border-secondary p-3">
                            ${post.topicTitle ? `<p class="card-text mb-0">${post.topicTitle}</p>` : ``}
                            ${post.topicContent ? `<p class="text-secondary mb-0">${post.topicContent}</p>` : ``}
                            ${post.topicContent ? `<p class="text-secondary mb-0"><i class="fa-solid fa-link"></i>${post.topicLink}</p>` : ``}
                          </div>` : ``}
                    </div>
