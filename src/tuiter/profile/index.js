  ...
  return (
    <>
      <div>
        <Link to="/tuiter">
          <div className="float-start">
            <i className="bi bi-arrow-left-short fs-4 text-black"></i>
          </div>
        </Link>

        <div className="ms-5">
          <h3 className="fw-bold m-0">{profile.firstName}</h3>
          <p className="m-0 text-secondary">114 Tuits</p>
        </div>
      </div>

      <div className="position-relative mt-2">
        <img className="w-100" src="/images/mountain.jpeg" alt="..." />
        <img
          className="position-absolute rounded-pill"
          style={{ height: "35%", width: "20%", left: "5%", bottom: "-20%" }}
      ...
      <Link to="/tuiter/edit-profile" className="clearfix">
        <button className="btn btn-primary fw-bold rounded-pill float-end mt-3">
          Edit Profile
        </button>
      </Link>
